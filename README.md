...
* [__ffmpeg__ and __threefive__](https://github.com/futzu/SCTE35-threefive/blob/master/threefive-ffmpeg.md) __threefive can read SCTE-35__ from
` Data: bin_data ([6][0][0][0] / 0x0006)` streams.
