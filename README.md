...
### threefive v2.4.79. is now available. 
...
# Latest __threefive__ version is `2`.`4`.`79`
> forgive me for the quick releases, we've expanded the cli, and added xml and sixfix, we had to shake some bugs out.
