# threefive
* threefive is a __SCTE-35 Decoder Encoder Parser library in Python3__.
...
* [__ffmpeg__ and __threefive__](https://github.com/futzu/SCTE35-threefive/blob/master/threefive-ffmpeg.md) threefive can read SCTE-35 from streams transcoded by ffmpeg  `Stream #0:0[0x100]: Data: bin_data ([6][0][0][0] / 0x0006)`
